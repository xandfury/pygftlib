...
CONN_TIMEOUT = 10  # remove all clients if they are inactive for over 30 seconds
MAX_NO_RESPONSE_TIME = 5  # Disconnect the client if no ACK(response is received from the server withing 5 seconds (say)
